...
network.add(layers.Conv2D(32, (3, 3), activation='relu', input_shape=(28, 28, 1), padding='valid'))
network.add(layers.MaxPooling2D((2, 2)))
#第二层：32个卷积核，每个大小3*3，池化2*2
network.add(layers.Conv2D(32, (3,3), padding='valid', activation='relu'))
network.add(layers.MaxPooling2D((2, 2)))
